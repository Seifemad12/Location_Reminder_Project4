...
import com.udacity.project4.locationreminders.geofence.GeoUtils
...
class SaveReminderFragment : BaseFragment() {
    ...
    private lateinit var newReminderDataItem: ReminderDataItem
    ...
    private fun addGeoFenceForRemainder() {
        val currentGeofenceData = newReminderDataItem
        ...
        val geofence = Geofence.Builder()
            ...
            .setCircularRegion(
                ...
                GeoUtils.GEOFENCE_RADIUS_IN_METERS
            )
            .setExpirationDuration(GeoUtils.NEVER_EXPIRES)
        ...
        geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent)?.run {
            addOnSuccessListener {
                _viewModel.validateAndSaveReminder(newReminderDataItem)
            }
